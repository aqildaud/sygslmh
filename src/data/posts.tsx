...
let obj = {
  ...
  content: `
      <p>Since I started working in July 2023, I feel like I've been doing pretty
    ...
    big reason for my success so far.</p>
  
    <p>Now, I'd consider myself an introvert, but I still try my best to
    ...
    definitely watch Summit of the Gods—it's amazing!" (Seriously, it is.)</p>
  
    <p>Those small, casual interactions, like when you bump into someone in the
    ...
    matters.</p>
     ...
     <p>On the flip side, I've noticed that with colleagues I don't interact
    ...
    smoother if we'd had a few casual chats beforehand.</p>
  
    <p>Try to build those small connections with the people you work with.
    You'll find that it makes everything run a lot smoother in the long run.</p>
  `,
